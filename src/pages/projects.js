        ...
        <Layout location={location} title={"Projects"} preMain={
            ...
            >
                ...
                <div class="notification is-warning is-light">
                    ...
                    <p>So please keep in mind that these projects are old. Very old.</p>
                </div>
                <div className="box">
                    <h3>Bandit Revolvers (2009 – 2011)</h3>
                    <div className="media">
                        <div className="media-left">
                            <img alt="Bandit Revolvers Screenshot" src={BanditRevolersImage} />
                        </div>
                ...
                <div className="box">
                    ...
                    <div className="media">
                        ...
                        <div className="media-content">
                            ...
                            <p>An interesting way to look back on the history is to look at it using the <a href="http://web.archive.org/web/*/http://www.apparatuscomplex.com">Internet Archive Wayback Machine</a>. It’s a little scary to see what life was like for me 5-6 years ago.</p>
                            <h4>Now</h4>
